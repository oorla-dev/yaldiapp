...
// Sample Data - Updated with correct tracklists and directories
const albums = [
  {
    id: 1,
    title: "YALDHI",
  ...
  },
  {
    ...
    year: "2024",
    cover:
      "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='200' height='200' viewBox='0 0 200 200'><rect width='200' height='200' fill='%23333'/><text x='100' y='110' text-anchor='middle' font-family='Arial' font-size='24' fill='white' font-weight='bold'>BULDY</text></svg>",
    tracks: [
      { id: 9, title: "PREACHER ALDI", duration: "3:42", file: "BULDY/PREACHER ALDI.mp3" },
      { id: 10, title: "ALDY AND THE BEAST", duration: "4:18", file: "BULDY/ALDY AND THE BEAST.mp3" },
      { id: 11, title: "I CANT ALDI", duration: "3:55", file: "BULDY/I CANT ALDI.mp3" },
      { id: 12, title: "BESAME ALDÍ", duration: "3:28", file: "BULDY/BESAME ALDÍ.mp3" },
      { id: 13, title: "BULDY", duration: "4:07", file: "BULDY/BULDY.mp3" },
      { id: 14, title: "ALDIES (CIRCLES)", duration: "3:33", file: "BULDY/ALDIES (CIRCLES).mp3" },
      { id: 15, title: "LOOSING YOUR ALDI", duration: "4:25", file: "BULDY/LOOSING YOUR ALDI.mp3" },
      { id: 16, title: "ALDI AND LOWS", duration: "3:51", file: "BULDY/ALDI AND LOWS.mp3" },
    ],
  },
  {
    id: 3,
    ...
    year: "2024",
    cover:
      "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='200' height='200' viewBox='0 0 200 200'><rect width='200' height='200' fill='%234a4a4a'/><text x='100' y='110' text-anchor='middle' font-family='Arial' font-size='20' fill='white' font-weight='bold'>DONDA 2</text></svg>",
    tracks: [
      { id: 17, title: "Track 1", duration: "3:45", file: "DONDA2/audio4.mp3" },
      { id: 18, title: "Track 2", duration: "4:20", file: "DONDA2/audio5.mp3" },
    ],
  },
  {
    id: 4,
    ...
    tracks: [
      { id: 19, title: "Radio Hit", duration: "3:30", file: "FM/audio6.mp3" },
      { id: 20, title: "Frequency", duration: "4:05", file: "FM/audio7.mp3" },
    ],
  },
]
...
const products = [
  ...
  },
  {
    ...
    category: "music",
    image:
      "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='300' height='300' viewBox='0 0 300 300'><circle cx='150' cy='150' r='140' fill='%23333'/><circle cx='150' cy='150' r='20' fill='%23666'/><text x='150' y='250' text-anchor='middle' font-family='Arial' font-size='16' fill='%23666'>BULDY Vinyl</text></svg>",
    sizes: ["One Size"],
  },
  {
    id: 4,
